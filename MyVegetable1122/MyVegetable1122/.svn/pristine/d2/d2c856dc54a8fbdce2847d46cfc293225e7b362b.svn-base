...
#warning 刚加入的
//    // 如果是滚动到第1张，那是实际的contentOffSet是滚动到倒数第二张
//    if(scrollView.contentOffset.x == 0) {
//        scrollView.contentOffset = CGPointMake((self.totalViewCount-2) * self.totalWidth, 0);
//    }// 如果是滚动到最后一张，那是实际的contentOffSet是滚动到第二张
//    if (scrollView.contentOffset.x == (self.totalViewCount-1) * self.totalWidth) {
//        scrollView.contentOffset = CGPointMake(self.totalWidth, 0);
//    }

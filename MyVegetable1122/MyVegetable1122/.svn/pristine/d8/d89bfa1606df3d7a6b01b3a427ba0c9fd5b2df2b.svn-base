...
+ (void)initialize
{
    if (self == [PICircularProgressView class])
    {
        ...
        [appearance setProgressTopGradientColor:[UIColor colorWithRed:233.0/255.0 green:63.0/255.0 blue:74/255.0 alpha:1.0]];
        [appearance setProgressBottomGradientColor:[UIColor colorWithRed:229.0/255.0 green:179.0/255.0 blue:164.0/255.0 alpha:1.0]];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_showShadow)
    {
        ...
        NSArray *gradientColors = @[
                                    (id)[[UIColor colorWithWhite:0.2 alpha:0.1] CGColor],
                                    (id)[[UIColor colorWithWhite:0.2 alpha:0.1] CGColor],
                                    (id)[[UIColor colorWithWhite:0.2 alpha:0.1] CGColor],
                                    (id)[[UIColor colorWithWhite:0.2 alpha:0.1] CGColor],
                                    ];
...
//        progressString drawAtPoint:origin withAttributes:<#(nullable NSDictionary<NSString *,id> *)#>
    }
    ...
    if (_roundedHead)
    {
        ...
        [path addArcWithCenter:point
                    ...
                    startAngle:DEGREES_TO_RADIANS(90)
                      endAngle:DEGREES_TO_RADIANS(-90)
                     clockwise:YES];//设置为NO，那么就是凹进去，设置YES就是凸出来

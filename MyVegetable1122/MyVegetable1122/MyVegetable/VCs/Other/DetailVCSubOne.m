            ...
            if (dict){
                ...
                if (self.pageNum == 1) {
                    ...
                    if ([dic isKindOfClass:[NSArray class]]) {
                        ...
                        NSDictionary *dic = [arr objectAtIndex:t];
                        JMessageModel *jmm = [[JMessageModel alloc]init];
                        jmm.title = dic[@"title"];
                        jmm.text = dic[@"content"];
...
- (NSArray *)arr {
    ...
    NSArray *arr  = @[@[@"银行存管",@"投资人资金由恒丰银行存管，资金去向明确可靠。"],
                      ...
                      @[@"账户资金交易安全",@"阳光财险保险公司对每笔交易承担保险责任，从充值、提现、投资、还款等各个环节全面保障投资者的资金安全，为你在我的菜理财的资金安全保驾护航，让您的投资更安全放心。"],@[@"银行存管",@"投资人资金由恒丰银行存管，资金去向明确可靠。"],
                      @[@"风险备付金",@"公司自有资金中划拨相应的起始资金存放于风险储备金账户中。平台每笔借款成交时，提取0.1%的成交金额放入“风险备付金账户”。借款出现逾期时，则先启动“风险备用金”先行向投资人垫付此笔借款的剩余出借本息。"],
                      @[@"债权回购金",@"从公司自有资金中划拨一定数量的起始资金存放于债权回购金账户中。平台不定期补充或增加资金放入 “债权回购金账户”。若风险备付金不足以垫付或回购时，则启动“债权回购金”向投资人垫付此笔借款的剩余出借本息。"], @[@"风险备付金",@"公司自有资金中划拨相应的起始资金存放于风险储备金账户中。平台每笔借款成交时，提取0.1%的成交金额放入“风险备付金账户”。借款出现逾期时，则先启动“风险备用金”先行向投资人垫付此笔借款的剩余出借本息。"],
                      @[@"债权回购金",@"从公司自有资金中划拨一定数量的起始资金存放于债权回购金账户中。平台不定期补充或增加资金放入 “债权回购金账户”。若风险备付金不足以垫付或回购时，则启动“债权回购金”向投资人垫付此笔借款的剩余出借本息。"], @[@"风险备付金",@"公司自有资金中划拨相应的起始资金存放于风险储备金账户中。平台每笔借款成交时，提取0.1%的成交金额放入“风险备付金账户”。借款出现逾期时，则先启动“风险备用金”先行向投资人垫付此笔借款的剩余出借本息。"],
                      @[@"债权回购金",@"从公司自有资金中划拨一定数量的起始资金存放于债权回购金账户中。平台不定期补充或增加资金放入 “债权回购金账户”。若风险备付金不足以垫付或回购时，则启动“债权回购金”向投资人垫付此笔借款的剩余出借本息。"], @[@"风险备付金",@"公司自有资金中划拨相应的起始资金存放于风险储备金账户中。平台每笔借款成交时，提取0.1%的成交金额放入“风险备付金账户”。借款出现逾期时，则先启动“风险备用金”先行向投资人垫付此笔借款的剩余出借本息。"],
                      @[@"债权回购金",@"从公司自有资金中划拨一定数量的起始资金存放于债权回购金账户中。平台不定期补充或增加资金放入 “债权回购金账户”。若风险备付金不足以垫付或回购时，则启动“债权回购金”向投资人垫付此笔借款的剩余出借本息。"]];

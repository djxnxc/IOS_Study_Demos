...
//                hb.url=@"http://static.wdclc.cn/wx/pages/problem.html";
                hb.url=@"http://139.224.232.131:9081/web/wx/pages/problem.html";
        ...
        switch (indexPath.row) {
            ...
            case 1:{//联系我们
                ...
                AboutUs *a = [[AboutUs alloc]initWithNibName:@"AboutUs" bundle:nil];
                a.hidesBottomBarWhenPushed = YES;
                [self.navigationController pushViewController:a animated:YES];
                break;
            }
...
#pragma mark - 弹框
- (void)creatPopView {
    ZendaiAlertView *alert = [[ZendaiAlertView alloc] initWithTitle:@"联系电话" contentText:@"您要拨打400-0087-260电话吗？" leftButtonTitle:@"取消" rightButtonTitle:@"确定"];
    ...
    alert.rightBlock = ^(){
        ...
        NSMutableString * str=[[NSMutableString alloc] initWithFormat:@"tel:%@",@"400-0087-260"];
